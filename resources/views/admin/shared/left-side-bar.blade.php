<div class="card overflow-hidden">
    <div class="card-body pt-3">
        <ul class="nav nav-link-secondary flex-column fw-bold gap-2">
            <li class="nav-item">
                <a class="{{ (Route::is('admin.dashboard')) ? 'text-white bg-dark rounded' : ''}} nav-link"
                   href="{{route('admin.dashboard')}}">
                    <i class="fa-solid fa-chart-line"></i>
                    <span>Dashboard</span></a>
            </li>
            <li class="nav-item">
                <a class="{{ (Route::is('admin.users.index')) ? 'text-white bg-dark rounded' : ''}} nav-link"
                   href="{{route('admin.users.index')}}">
                    <i class="fa-solid fa-users" style="color: #0f91f5;"></i>
                    <span>Users</span></a>
            </li>
            <li class="nav-item">
                <a class="{{ (Route::is('admin.ideas.index')) ? 'text-white bg-dark rounded' : ''}} nav-link"
                   href="{{route('admin.ideas.index')}}">
                    <i class="fa-solid fa-lightbulb" style="color: #FFD43B;"></i>
                    <span>Ideas</span></a>
            </li>
            <li class="nav-item">
                <a class="{{ (Route::is('admin.comments.index')) ? 'text-white bg-dark rounded' : ''}} nav-link"
